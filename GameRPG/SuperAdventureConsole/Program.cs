    ...
    public class Program
    {
        ...
        private static void ParseInput(string input)
        {
            ...
            else if (input == "stats")
            {
                ...
                Console.WriteLine("EXP: {0}", _player.ExperiencePoints);
            ...
            else if (input == "quests")
            {
                ...
                {
                    Console.WriteLine("You don't have any Quests rn! ");
                }
                else
                {
                    foreach (PlayerQuest playerQuest in _player.Quests)
                    {
                       ...
                       , playerQuest.name, playerQuest.IsCompleted ? "Completed" : "InComplete");
                    }
                }
            }
            else if (input.Contains("attack"))
            {
                ...
                else
                {
                    ...
                    {
                        // select first weapon in slot
                        _player.CurrentWeapon = _player.Weapons.SingleOrDefault();
                    }
                    // if nothing found then print it
                    if (_player.CurrentWeapon == null)
                    {
    ...
    _player.Weapons.SingleOrDefault(x => x.Name.ToLower() == inputWeaponName || x.NamePlural.ToLower() == inputWeaponName);
            ...
            else if (input == "trade")
            {
                ...
                else
                {
                    ...
                    {
                        foreach (InventoryItem inventoryItem in _player.Inventory.Where
